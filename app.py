...
with tab1:
    ...
    st.write(
        ...
        or cloud study guides. Later, this mode will use RAG to search your documents
        and answer questions based on your files.
        """
    )
    ...
    if st.button("Ask Document Question"):
        if not uploaded_files:
            ...
            st.write(
                """
                This is a placeholder answer. In the next version, the app will:
                
                1. Read your uploaded documents  
                2. Split them into chunks  
                3. Search for the most relevant chunks  
                4. Send the context to an LLM  
                5. Return an interview-focused answer with references  
                """
            )
